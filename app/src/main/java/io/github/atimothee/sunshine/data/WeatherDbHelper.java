...
public class WeatherDbHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_LOCATION_TABLE = LocationEntry._ID+" INTEGER PRIMARY KEY, "+
        ...
        final String SQL_CREATE_WEATHER_TABLE = WeatherEntry._ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+
